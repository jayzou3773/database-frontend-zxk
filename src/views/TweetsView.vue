...
<template>
    ...
    <div class="card_1">
        <el-card   class="custom-card" style="max-width: 1000px; flex: 65;" shadow="hover" @click="showNotification(equipmentList)">
        ...
        <el-card   class="custom-card" style="max-width: 1000px; flex: 35;" shadow="hover" @click="showNotification2(equipmentList)">
    ...
    <div class="card_2">
        <el-card    class="custom-card" style="max-width: 1000px; flex: 32;" shadow="hover" @click="showNotification3(equipmentList)">
        ...
        <el-card   class="custom-card" style="max-width: 1000px; flex: 32;" shadow="hover" @click="showNotification4(equipmentList)">
        ...
        <el-card  class="custom-card" style="max-width: 1000px; flex: 35;" shadow="hover" @click="showNotification5(equipmentList)">
            <img :src="equipmentList.value[4].imgUrl" class="hover-zoom" style="width: 100%; height: 250px; object-fit: cover;" />
            <div class="footer-content" style="background-color: #ededed; text-align: left;">
                <br>
                <p style="font-size: 30px; margin-left: 25px; margin-right: 25px; color: rgb(0, 0, 0); font-weight: bold ;">
    ...
    <div class="card_3">
        <el-card class="custom-card" style="max-width: 1000px; flex: 65;" shadow="hover" @click="showNotification6(equipmentList)">
            <img :src="equipmentList.value[5].imgUrl" class="hover-zoom" style="width: 100%; height: 300px; object-fit: cover;" />
            <div class="footer-content" style="background-color: #ffffff; text-align: left;">
                <br>
                <p style="font-size: 30px; margin-left: 25px; margin-right: 25px; font-weight: bold ;">
        ...
        <el-card  class="custom-card" style="max-width: 1000px; flex: 35;" shadow="hover" @click="showNotification7(equipmentList)">
